 ...
 */
public class DetailedUser implements Parcelable {
     ...
     * updated_at : 2016-07-12T20:04:09Z
     */
    ...
    protected DetailedUser(Parcel in) {
    ...
    public static final Creator<DetailedUser> CREATOR = new Creator<DetailedUser>() {
        @Override
        public DetailedUser createFromParcel(Parcel source) {
            return new DetailedUser(source);
        }

        @Override
        public DetailedUser[] newArray(int size) {
            return new DetailedUser[size];
        }
    };
